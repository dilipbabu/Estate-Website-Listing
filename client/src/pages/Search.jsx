  ...
  return (
    <div className="flex flex-col md:flex-row">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-10">
          <div className="flex items-center gap-3 ">
            ...
            <input
              ...
              className="bg-slate-200 p-3  w-full rounded-xl transform hover:scale-90 transition-transform duration-700"
      ...
      <div className="flex-auto">
        <h1 className="text-4xl font-semibold border-b p-3 mt-5 ">
          Listing Results:{" "}
        </h1>
        <div className="p-9 flex flex-wrap gap-10">
          {!loading && listings.length === 0 && (
            <p className="text-2xl">No Listing Found!</p>
          )}
          {loading && <p className="text-2xl text-center w-full">Loading...</p>}
          {!loading &&
            listings &&
          ...
          {showMore && (
            <button
              ...
              className="hover:underline p-7 w-full text-center"
            >
              Show More
            </button>
          )}
